...
from settings.configs import API_VERSION, API_PATH_FASTAPI_STATE, API_DOC
...
log_controler = LogControler(port=API_PATH_FASTAPI_STATE)
...
app = FastAPI(
    ...
    version=API_VERSION,
    docs_url=f"{API_PATH_FASTAPI_STATE}{API_DOC}",
    redoc_url=None,
    openapi_url=f"{API_PATH_FASTAPI_STATE}{API_DOC}/openapi.json"
)
...
app.include_router(api_router, prefix=API_PATH_FASTAPI_STATE)