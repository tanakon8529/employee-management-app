...
MICROSERVICE_NAME_FASTAPI_DEPARTMENT = "fastapi-department"
MICROSERVICE_NAME_FASTAPI_STATE = "fastapi-state"
...
def set_microservice_name_by_api_path(api_path):
    ...
    elif api_path == MICROSERVICE_NAME_FASTAPI_DEPARTMENT:
        return MICROSERVICE_NAME_FASTAPI_DEPARTMENT
    elif api_path == MICROSERVICE_NAME_FASTAPI_STATE:
        return MICROSERVICE_NAME_FASTAPI_STATE
    else:
        return "Unknown"
...
API_PATH_FASTAPI_DEPARTMENT = os.environ["API_PATH_FASTAPI_DEPARTMENT"]
API_PATH_FASTAPI_STATE = os.environ["API_PATH_FASTAPI_STATE"]
...
PORT_FASTAPI_STATE = os.environ["PORT_FASTAPI_STATE"]
